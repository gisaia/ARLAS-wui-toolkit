...
docker run -a STDERR --rm -i -v `pwd`:/docs gisaia/typedocgen:0.0.11 generatedoc --entryPoints projects/arlas-toolkit/src/public-api.ts --tsconfig projects/arlas-toolkit/tsconfig.lib.json
