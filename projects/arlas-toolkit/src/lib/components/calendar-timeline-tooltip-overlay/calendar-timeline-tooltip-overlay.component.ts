...
@Component({
  ...
  styleUrls: ['./calendar-timeline-tooltip-overlay.component.scss']
})
export class CalendarTimelineTooltipOverlayComponent {

  public constructor(public overlayRef: ArlasOverlayRef, @Inject(CALENDAR_TIMELINE_TOOLTIP_DATA) public tooltip: TimelineTooltip) {}
