...
@Component({
  ...
  standalone: true,
  imports: [
    CdkScrollable, MatDialogContent, MatDialogTitle, MatFormField,
    MatInput, FormsModule, ReactiveFormsModule, NgIf, MatError,
    MatDialogActions, MatButton, TranslateModule
  ]
})
