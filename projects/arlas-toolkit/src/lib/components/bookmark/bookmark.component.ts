...
@Component({
  ...
  imports: [
    ...
    MatCell, MatCheckbox, MatIcon, MatMenuTrigger, MatMenu, MatMenuItem, MatTooltip,
    MatHeaderRowDef, MatHeaderRow, MatRowDef, MatRow, NgIf, MatButton, MatDialogActions,
    MatDialogClose, AsyncPipe, DatePipe, TranslateModule]
})
